          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a 
                ...
                className="p-3 bg-tertiary rounded-full hover:bg-secondary transition-colors group"
                aria-label="GitHub Profile"
              >
                <svg className="w-6 h-6 text-white group-hover:text-primary" fill="currentColor" viewBox="0 0 24 24">
